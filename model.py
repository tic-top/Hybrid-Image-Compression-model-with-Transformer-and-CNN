...
class ImageCompressor(nn.Module):
    def __init__(self, out_channel_N=192, out_channel_M=320):
        ...
        self.Encoder = SwinTanalysis(img_size=256,patch_size=2,embed_dim=40,window_size=8)
        self.Decoder = SwinTsynthesis(img_size=256,patch_size=2,embed_dim=40,window_size=8)
    ...
    def forward(self, input_image):
        ...
        # return compressed_feature_renorm, mse_loss, bpp_feature, bpp_z, bpp
